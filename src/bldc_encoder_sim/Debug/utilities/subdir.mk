...
utilities/%.o: ../utilities/%.S utilities/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__REDLIB__ -I"C:\Users\Jerry\Desktop\Wavenumber\MedicalCentrifuge\SWR-00005__H6DC\src\HallEfectSimulator\encoder_sim\source" -g3 -gdwarf-4 -mcpu=cortex-m33+nodsp -mthumb -D__REDLIB__ -specs=redlib.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
