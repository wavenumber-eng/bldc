...
tinyusb/src/class/usbtmc/%.o: ../tinyusb/src/class/usbtmc/%.c tinyusb/src/class/usbtmc/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-usbtmc:
	-$(RM) ./tinyusb/src/class/usbtmc/usbtmc_device.d ./tinyusb/src/class/usbtmc/usbtmc_device.o
