...
tinyusb/src/class/bth/%.o: ../tinyusb/src/class/bth/%.c tinyusb/src/class/bth/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-bth:
	-$(RM) ./tinyusb/src/class/bth/bth_device.d ./tinyusb/src/class/bth/bth_device.o
