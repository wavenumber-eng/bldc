...
tinyusb/src/class/video/%.o: ../tinyusb/src/class/video/%.c tinyusb/src/class/video/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-video:
	-$(RM) ./tinyusb/src/class/video/video_device.d ./tinyusb/src/class/video/video_device.o
