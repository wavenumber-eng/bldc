...
tinyusb/src/class/midi/%.o: ../tinyusb/src/class/midi/%.c tinyusb/src/class/midi/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-midi:
	-$(RM) ./tinyusb/src/class/midi/midi_device.d ./tinyusb/src/class/midi/midi_device.o
