...
tinyusb/src/class/audio/%.o: ../tinyusb/src/class/audio/%.c tinyusb/src/class/audio/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-audio:
	-$(RM) ./tinyusb/src/class/audio/audio_device.d ./tinyusb/src/class/audio/audio_device.o
