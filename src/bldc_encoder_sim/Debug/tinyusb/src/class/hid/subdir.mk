...
tinyusb/src/class/hid/%.o: ../tinyusb/src/class/hid/%.c tinyusb/src/class/hid/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-hid:
	-$(RM) ./tinyusb/src/class/hid/hid_device.d ./tinyusb/src/class/hid/hid_device.o ./tinyusb/src/class/hid/hid_host.d ./tinyusb/src/class/hid/hid_host.o
