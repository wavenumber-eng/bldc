...
tinyusb/src/device/%.o: ../tinyusb/src/device/%.c tinyusb/src/device/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-device:
	-$(RM) ./tinyusb/src/device/usbd.d ./tinyusb/src/device/usbd.o ./tinyusb/src/device/usbd_control.d ./tinyusb/src/device/usbd_control.o
