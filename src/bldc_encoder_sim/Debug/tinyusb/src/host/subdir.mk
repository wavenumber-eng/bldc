...
tinyusb/src/host/%.o: ../tinyusb/src/host/%.c tinyusb/src/host/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-host:
	-$(RM) ./tinyusb/src/host/hub.d ./tinyusb/src/host/hub.o ./tinyusb/src/host/usbh.d ./tinyusb/src/host/usbh.o
