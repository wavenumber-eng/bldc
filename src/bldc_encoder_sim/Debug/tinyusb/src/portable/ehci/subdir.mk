...
tinyusb/src/portable/ehci/%.o: ../tinyusb/src/portable/ehci/%.c tinyusb/src/portable/ehci/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-portable-2f-ehci:
	-$(RM) ./tinyusb/src/portable/ehci/ehci.d ./tinyusb/src/portable/ehci/ehci.o
