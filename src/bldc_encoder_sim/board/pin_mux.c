...
pin_labels:
- {pin_num: '4', pin_signal: P1_10/LPUART1_RTS_B/LPI2C0_SDAS/CT2_MAT0/ADC0_A8, label: POS_S1, identifier: POS_S1}
- {pin_num: '6', pin_signal: P1_12/WUU0_IN12/LPUART2_RXD/CT2_MAT2/ADC0_A10, label: POS_S2, identifier: POS_S2}
- {pin_num: '7', pin_signal: P1_13/TRIG_IN3/LPUART2_TXD/CT2_MAT3/ADC0_A11, label: POS_S3, identifier: POS_S3}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t POS_S1_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_10 (pin 4)  */
    GPIO_PinInit(BOARD_INITPINS_POS_S1_GPIO, BOARD_INITPINS_POS_S1_PIN, &POS_S1_config);

    gpio_pin_config_t POS_S2_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_12 (pin 6)  */
    GPIO_PinInit(BOARD_INITPINS_POS_S2_GPIO, BOARD_INITPINS_POS_S2_PIN, &POS_S2_config);

    gpio_pin_config_t POS_S3_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_13 (pin 7)  */
    GPIO_PinInit(BOARD_INITPINS_POS_S3_GPIO, BOARD_INITPINS_POS_S3_PIN, &POS_S3_config);
    ...
    PORT_SetPinMux(BOARD_INITPINS_POS_S1_PORT, BOARD_INITPINS_POS_S1_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITPINS_POS_S2_PORT, BOARD_INITPINS_POS_S2_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITPINS_POS_S3_PORT, BOARD_INITPINS_POS_S3_PIN, kPORT_MuxAlt0);
