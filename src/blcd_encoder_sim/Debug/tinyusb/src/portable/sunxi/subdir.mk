...
tinyusb/src/portable/sunxi/%.o: ../tinyusb/src/portable/sunxi/%.c tinyusb/src/portable/sunxi/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-portable-2f-sunxi:
	-$(RM) ./tinyusb/src/portable/sunxi/dcd_sunxi_musb.d ./tinyusb/src/portable/sunxi/dcd_sunxi_musb.o
