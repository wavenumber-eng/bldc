...
tinyusb/src/class/msc/%.o: ../tinyusb/src/class/msc/%.c tinyusb/src/class/msc/subdir.mk
	@echo 'Building file: $<'
...
clean-tinyusb-2f-src-2f-class-2f-msc:
	-$(RM) ./tinyusb/src/class/msc/msc_device.d ./tinyusb/src/class/msc/msc_device.o ./tinyusb/src/class/msc/msc_host.d ./tinyusb/src/class/msc/msc_host.o
